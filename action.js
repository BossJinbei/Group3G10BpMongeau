...
if (screen.width < 400) {
    ...
    //Change transformation duration and translate for mobile view
...
function openlink(x) {
    if (x == 1) {
        window.open("https://www.facebook.com/share/g/15hDVv3Mx9/", "_blank");
    }
    if (x == 2) {
        window.open("https://www.facebook.com/share/g/15hDVv3Mx9/", "_blank");
    }
